...
{
    [Authorize(Roles = "Tenant")] // Chỉ cho phép Role Tenant truy cập
    public class TenantPortalController : Controller
    {
        ...
        public async Task<IActionResult> Dashboard()
        {
            ...
            try
            {
                // Gọi song song 3 API để tăng tốc độ load trang
                ...
                // Đọc dữ liệu Profile (Map vào class tương ứng của bạn)
